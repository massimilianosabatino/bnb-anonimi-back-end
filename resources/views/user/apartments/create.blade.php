...
<form action="{{ route('user.dashboard.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="title" name="title" placeholder="insert the title of your apartment"
            value="{{ old('title') }}">
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="rooms" name="rooms" placeholder="insert the number of rooms"
            value="{{ old('rooms') }}">
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="bathrooms" name="bathrooms" placeholder="insert the number of bathrooms"
            value="{{ old('bathrooms') }}">
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="beds" name="beds" placeholder="insert the number of beds"
            value="{{ old('beds') }}">
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="square_meters" name="square_meters" placeholder="insert the Square meters"
